...
//   return (
//     <TodoProvider value={{ todos, addTodo, updateTodo, deleteTodo, toggleComplete }}>
//       <div className="bg-pink-100 min-h-screen py-8 flex justify-center items-center">
//         <div className="w-full max-w-2xl mx-auto shadow-lg rounded-lg px-6 py-4 text-pink-900 bg-pink-200">
