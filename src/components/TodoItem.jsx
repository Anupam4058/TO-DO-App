...
//     return (
//         <div
//             className={`flex border border-pink-300 rounded-lg px-4 py-2 gap-x-3 shadow-md duration-300 text-pink-900 ${
...
//             <input
//                 type="text"
//                 className={`border outline-none w-full bg-transparent rounded-lg px-2 text-lg ${
