...
//     return (
//         <form onSubmit={add} className="flex w-full bg-pink-200 p-3 rounded-lg shadow-lg">
//             <input
//                 type="text"
...
//                 onChange={(e) => setTodo(e.target.value)}
//             />
//             <button type="submit" className="rounded-r-lg px-4 py-2 bg-pink-500 text-white font-semibold hover:bg-pink-600 transition-all shadow-md">
//                 Add 💖
//             </button>
//         </form>
//     );
